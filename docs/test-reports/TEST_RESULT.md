...
> **Thời gian báo cáo:** `2026-06-06 22:42:45`
...
| **Thành công (Passed)** | `215` |
| **Thất bại (Failed)** | `0` |
| **Bỏ qua (Skipped)** | `0` |
| **Tỷ lệ thành công** | **100.0%** |
| **Tổng thời gian chạy** | `3.15 s` |
...
| SUCCESS | `AttendanceControllerBlackBoxTest` | Black-box GET /api/v1/attendance/range - Admin should get company records in date range | `7 ms` |
...
| SUCCESS | `AttendanceControllerBlackBoxTest` | Black-box PUT /api/v1/attendance/{id} - Admin should update attendance record | `6 ms` |
...
| SUCCESS | `AttendanceServiceImplTest` | Unit checkIn - Valid GPS/IP should create attendance record | `20 ms` |
| SUCCESS | `AttendanceServiceImplTest` | Unit checkOut - Early checkout should mark EARLY_LEAVE | `42 ms` |
| SUCCESS | `AttendanceServiceImplTest` | Unit checkOut - Overtime should be capped by approved OT request | `2 ms` |
| SUCCESS | `AttendanceStressTest` | Stress Test - Race Condition protection: Double check-in concurrently returns only 1 success | `13 ms` |
| SUCCESS | `AttendanceStressTest` | Stress Test - Simulating 200 employees check-in at peak start of shift concurrently | `55 ms` |
...
| SUCCESS | `ContractControllerBlackBoxTest` | Black-box GET /api/v1/contracts/employee/{employeeId} - Returns employee contract history | `3 ms` |
...
| SUCCESS | `ContractServiceImplTest` | Unit createContract - INDEFINITE contract may omit end date | `36 ms` |
...
| SUCCESS | `ContractServiceImplTest` | Unit getContractsByEmployee - Existing employee should return contract history | `0 ms` |
...
| SUCCESS | `DepartmentControllerBlackBoxTest` | Black-box DELETE /api/v1/departments/{id} - Should call delete service | `2 ms` |
...
| SUCCESS | `DepartmentControllerBlackBoxTest` | Black-box POST /api/v1/departments - Missing code and name should return validation errors | `30 ms` |
...
| SUCCESS | `DepartmentControllerBlackBoxTest` | Black-box PUT /api/v1/departments/{id} - Valid payload should update department | `3 ms` |
| SUCCESS | `DepartmentServiceImplTest` | Create Department - Duplicate department code should throw IllegalArgumentException | `113 ms` |
| SUCCESS | `DepartmentServiceImplTest` | Create Department - Valid request should successfully create department | `6 ms` |
...
| SUCCESS | `DepartmentServiceImplTest` | Delete Department - Empty department should be successfully deleted | `4 ms` |
...
| SUCCESS | `GofPrototypePatternTest` | Xác thực hoạt động của DepartmentPrototypeRegistry (Cache & Clone) | `0 ms` |
| SUCCESS | `GofPrototypePatternTest` | Xác thực hoạt động của LeaveTypePrototypeRegistry (Cache & Clone) | `0 ms` |
| SUCCESS | `GofPrototypePatternTest` | Xác thực hoạt động của ShiftPrototypeRegistry (Cache & Clone) | `1 ms` |
...
| SUCCESS | `HrmBackendApplicationTests` | contextLoads() | `223 ms` |
| SUCCESS | `HrmEndToEndIntegrationTest` | E2E - Employee attendance, leave, overtime and payroll flow should pass through security, services and DB | `1221 ms` |
...
| SUCCESS | `LeaveBalanceControllerBlackBoxTest` | Black-box GET /api/v1/leave-balances/my - Returns current employee balances | `65 ms` |
...
| SUCCESS | `LeaveBalanceServiceImplTest` | Unit getBalancesByEmployee - Existing employee should return balances with remaining days | `0 ms` |
| SUCCESS | `LeaveBalanceServiceImplTest` | Unit initBalanceForEmployee - Existing balance should be skipped | `4 ms` |
...
| SUCCESS | `LeaveBalanceServiceImplTest` | Unit refundBalance - Should subtract used days | `7 ms` |
...
| SUCCESS | `LeaveRequestControllerBlackBoxTest` | Black-box POST /api/v1/leave-requests - Missing required fields should return validation errors | `9 ms` |
| SUCCESS | `LeaveRequestControllerBlackBoxTest` | Black-box POST /api/v1/leave-requests - Non-positive days should return validation error | `34 ms` |
...
| SUCCESS | `LeaveRequestServiceImplTest` | Unit approveRequest - Non-pending request should throw IllegalArgumentException | `104 ms` |
| SUCCESS | `LeaveRequestServiceImplTest` | Unit approveRequest - Pending request should approve and deduct leave balance | `5 ms` |
...
| SUCCESS | `LeaveRequestServiceImplTest` | Unit submitRequest - End date before start date should throw IllegalArgumentException | `0 ms` |
...
| SUCCESS | `OvertimeRequestControllerBlackBoxTest` | Black-box DELETE /api/v1/overtime-requests/{id} - Should cancel own overtime request | `3 ms` |
...
| SUCCESS | `OvertimeRequestControllerBlackBoxTest` | Black-box POST /api/v1/overtime-requests - Valid payload should create overtime request | `31 ms` |
...
| SUCCESS | `OvertimeRequestServiceImplTest` | Unit approveRequest - Non-pending request should throw RuntimeException | `50 ms` |
...
| SUCCESS | `PayrollControllerBlackBoxTest` | Black-box GET /api/v1/payrolls - Admin should get monthly payroll page with filters | `7 ms` |
...
| SUCCESS | `PayrollControllerBlackBoxTest` | Black-box GET /api/v1/payrolls/employee/{employeeId} - Employee cannot view other employee payrolls | `5 ms` |
...
| SUCCESS | `PayrollControllerBlackBoxTest` | Black-box GET /api/v1/payrolls/{id} - Should get payroll detail | `4 ms` |
| SUCCESS | `PayrollControllerBlackBoxTest` | Black-box POST /api/v1/payrolls/generate - Admin should generate monthly draft payrolls | `78 ms` |
...
| SUCCESS | `PayrollServiceImplTest` | Unit bulkUpdatePayroll - Draft payroll should merge allowances and deductions | `11 ms` |
...
| SUCCESS | `PayrollServiceImplTest` | Unit markAsPaid - Non-approved payroll should throw IllegalArgumentException | `1 ms` |
| SUCCESS | `PayrollServiceImplTest` | Unit submitPayroll - Draft payroll should become CALCULATED | `257 ms` |
...
| SUCCESS | `PayslipReportExportTest` | Unit Test GoF Builder - Dựng phiếu lương định dạng HTML thông qua Director | `1 ms` |
| SUCCESS | `PayslipReportExportTest` | Unit Test GoF Builder - Dựng phiếu lương định dạng Text/Markdown thông qua Director | `1 ms` |
| SUCCESS | `PrototypePatternAuditorTest` | Chỉ ra lỗi Shallow Clone của Lombok @Builder(toBuilder=true) trên DepartmentResponse | `0 ms` |
| SUCCESS | `PrototypePatternAuditorTest` | Chỉ ra lỗi Shallow Clone của Lombok @Builder(toBuilder=true) trên PayrollResponse | `1 ms` |
| SUCCESS | `PrototypePatternAuditorTest` | Giải pháp khắc phục 1: Sử dụng cấu trúc Immutable Collections (Map.copyOf, List.copyOf) | `0 ms` |
