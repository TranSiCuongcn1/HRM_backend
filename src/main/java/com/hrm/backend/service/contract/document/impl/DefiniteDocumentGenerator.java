...
@Component
public class DefiniteDocumentGenerator implements ContractDocumentGenerator {
    ...
    public String generateSummary(String employeeName, String contractType,
        ...
        return String.format(
                ...
                "  <h3 style=\"color: #1d4ed8; margin-top: 0; font-size: 16px; border-bottom: 2px solid #3b82f6; padding-bottom: 8px;\">HỢP ĐỒNG XÁC ĐỊNH THỜI HẠN</h3>" +
                ...
                "    <tr><td style=\"padding: 6px 0; color: #64748b;\">Loại hợp đồng:</td><td style=\"padding: 6px 0; color: #1e293b; font-weight: 600;\">Xác định thời hạn (1 năm)</td></tr>" +
                ...
                "    <tr><td style=\"padding: 6px 0; color: #64748b;\">Lương thực hưởng (100%%):</td><td style=\"padding: 6px 0; color: #1d4ed8; font-weight: 700; font-size: 15px;\">%s</td></tr>" +
                "  </table>" +
                "  <div style=\"background-color: #eff6ff; border-left: 4px solid #3b82f6; padding: 12px; border-radius: 6px; font-size: 13px; color: #1e40af; line-height: 1.5;\">" +
                "    <strong>⚠️ Quy định lao động:</strong> Người sử dụng lao động được ký tối đa 02 lần hợp đồng lao động xác định thời hạn, sau đó phải chuyển sang ký hợp đồng vô thời hạn (Theo Điều 20 Bộ luật Lao động 2019)." +
                "  </div>" +
                "</div>",
    ...
    public String getContractTitle() {
        return "HỢP ĐỒNG LAO ĐỘNG XÁC ĐỊNH THỜI HẠN";
    }
